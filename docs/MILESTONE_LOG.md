...
- Phase 3.9 - outreach publication ranking: publication selection now sorts by an explainable outreach score weighted toward research-portfolio similarity, with alternate sort modes for newest, highest citation count, and fewest authors.
